input = read.csv("comment_strong_increasing_11-7-2016.csv") #12197
...
almost.no.comment  = input[input$X20.6...26.6.com + input$X13.6...19.6.com <=2,] #4765
still.comment.alot = input[input$X20.6...26.6.com + input$X13.6...19.6.com >= 10 ,] #4366
nomal.comment = input[input$X20.6...26.6.com + input$X13.6...19.6.com >2
                      & input$X20.6...26.6.com + input$X13.6...19.6.com <10,] #3066
