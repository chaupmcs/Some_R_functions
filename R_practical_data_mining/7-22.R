...
length(chat_week2) + length(no_chat_week2_ori)
chat_week2 = chat.users[index]
no_chat_week2_ori = chat.users[-index]
...
table2 = cbind.data.frame(c("1-4", "5-8", "9-11", ">=12"),d.number.each.cate)
